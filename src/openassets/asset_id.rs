...
mod tests {
    ...
    fn test_calculate_asset_id() {
        ...
        let p2pkh_asset = AssetId { hash: hash160::Hash::hash(&p2pkh.to_bytes()), network: bitcoin::network::constants::Network::Bitcoin };
        ...
        let testnet_asset = AssetId { hash: hash160::Hash::hash(&p2sh.to_bytes()), network: bitcoin::network::constants::Network::Testnet };
